        ...
        <div className="py-12 md:py-20 border-t border-gray-200">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="-my-3">
              {/* 1st Item */}
              <a
                className="flex justify-between items-center p-4 rounded border border-gray-200 transition duration-300 ease-in-out bg-gray-100 shadow</svg>-md hover:bg-white hover:shadow-lg mb-3"
                href="#0"
              >
