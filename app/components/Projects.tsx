...
export default function Projects() {
  return (
    <section id="du-an" className="scroll-mt-20 relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Các dự án đã thực hiện</h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">
              Chúng tôi đã và đang phục vụ 20 khách hàng lớn nhỏ. Với hơn 100 dự
              án đã hoàn thành và bàn giao cho khách hàng.
            </p>
          </div>
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src="/partners/mega.png" width={124} height={24} alt="" />
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image
                src="/partners/dong-a.gif"
                width={124}
                height={24}
                alt=""
              />
