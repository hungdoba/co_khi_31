          ...
          <div className="grid overflow-hidden sm:grid-cols-2 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Gia công tiện CNC</span>
              </h3>
              <ul className="text-gray-400 list-disc list-inside">
                <li>
                  Gia công trên máy tiện dài 3m và ngắn 1m (xuất xứ Nhật Bản).
                </li>
                <li>
                  Chuyên gia công chi tiết lớn, chi tiết dài và yêu cầu độ chính
                  xác cao.
                </li>
                <li>
                  Phục vụ sửa chữa máy móc công nghiệp, máy công trình, và các
                  nhà máy như bột đá, sữa, gỗ, nhựa.
                </li>
              </ul>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Gia công phay CNC</span>
              </h3>
              <ul className="text-gray-400 list-disc list-inside">
                <li>
                  Máy phay hiện đại bậc nhất Nghệ An với kích thước XYZ:
                  800-400-450mm, sai số 0.01mm.
                </li>
                <li>
                  Chuyên gia công chi tiết phức tạp đạt tiêu chuẩn bản vẽ.
                </li>
                <li>Thiết kế đồ gá, chi tiết máy theo yêu cầu.</li>
              </ul>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Hàn và cắt kim loại</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Trang bị máy hàn TIG, MIG, MAX, máy cắt plasma và hàn hồ quang
                hiện đại.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Kiểm soát kích thước</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Trang thiết bị đo kiểm chính xác, nhập khẩu từ Nhật Bản, đảm bảo
                chất lượng cao.
              </p>
            </article>
          </div>
